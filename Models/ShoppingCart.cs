...
namespace BethanysPieShop.Models
{
    public class ShoppingCart : IShoppingCart
    {
        ...
        //Constructor injection from dbContext
        ...
        /// <summary>
        /// Pass in service collection and use session to restore info about returning user
        /// Access dbContext
        /// Check if CartId is available for user; if not create a new GUID and restore value as CartId
        /// Set value of CartId to session
        /// </summary>
        /// <param name="services"></param>
        /// <returns>A fully created shopping cart</returns>
